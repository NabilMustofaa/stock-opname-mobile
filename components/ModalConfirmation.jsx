...
export default function ModalConfirmation({title, description,visible, setVisible, handleConfirm,state='danger' }) {
  return (
    <>
          ...
          <View className=" w-full pt-4 px-2 bg-white rounded-lg">
            ...
            <View className="w-full flex flex-row justify-center items-center py-2 px-4">
              <View className="flex-1 mr-2">
                <CustomButton title="Cancel" handlePress={() => setVisible(false)} containerStyles={state === 'success' ? ' border border-[#007BFF]' : ' border border-red-500'} textStyles={state === 'success' ? 'text-[#007BFF]' : 'text-red-500'} />
              </View>
              <View className="flex-1">
                <CustomButton title="Confirm" handlePress={() => handleConfirm()} containerStyles={state === 'success' ? ' bg-[#007BFF] border border-[#007BFF]' : ' bg-red-500 border border-red-500'} textStyles="text-white" />
              </View>
            </View>
          </View>
        </View>
